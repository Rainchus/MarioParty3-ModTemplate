...
# New Asset Adding
New assets can be added by mirroring the directory structure of `assets/mp3_extract` (which is generated by running `python ./mpromtool.py` for the first time) with `new_assets/mp3_extract`<br/>
